...
const schema = yup.object().shape({
  lengthWithHeels: yup.number().positive().integer().required(),
  pads: yup.string().required(),
    ...
    if (name) {
      if (email) {
        if (email.match(mailformat)) {
          if (data.blouseLength >= 14 && data.blouseLength <= 20) {
            if (data.shoulder >= 14 && data.shoulder <= 20) {
              if (data.sleeveLength >= 3 && data.sleeveLength <= 24) {
                if (data.pads == "Y" || data.pads == "N") {
                  if (
                    data.lengthWithHeels >= 39 &&
                    data.lengthWithHeels <= 46
                  ) {
                    const formData = {
                    ...
                    toast.error(
                      "Length With heels should be between 39-46 inches!",
                      {
                        style: {
                          color: "white",
                        },
                  ...
                  toast.error("Pads value should be Y or N!", {
                    style: {
                      color: "white",
                    },
                  });
            ...
            toast.error("Blouse Length should be between 14-20 inches!", {
              style: {
                color: "white",
              },
            });
