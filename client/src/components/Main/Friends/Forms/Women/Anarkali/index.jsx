...
const schema = yup.object().shape({
  ...
  bodyLength: yup.number().positive().integer().required(),
      ...
      if (email) {
        if (email.match(mailformat)) {
          if (data.bodyLength >= 14 && data.bodyLength <= 18) {
            if (data.shoulder >= 14 && data.shoulder <= 20) {
              if (data.sleeveLength >= 3 && data.sleeveLength <= 24) {
                if (data.length >= 55 && data.length <= 62) {
                  ...
                  toast.error("Length should be between 55-62 inches!", {
                    style: {
                      color: "white",
                    },
                  });
            ...
            toast.error("Body Length should be between 14-18 inches!", {
              style: {
                color: "white",
              },
            });
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Typography
                        ...
                        sx={{ fontSize: "13px" }}
                      >
                        From shoulder to underneath chest plus 1 inch
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Typography
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Typography
                        ...
                        sx={{ fontSize: "13px" }}
                      >
                        Circumference around body length
                      </Typography>
                    </TableCell>
                    <TableCell></TableCell>
                    <TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Typography
                        ...
                        sx={{ fontSize: "13px" }}
                      >
                        Measure from shoulder to floor plus heels
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Typography
